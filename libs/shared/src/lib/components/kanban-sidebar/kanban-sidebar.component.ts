...
@Component({
  ...
  template: `
    <aside
      class="hidden md:flex w-64 flex-col justify-between border-r border-gray-200 bg-white dark:bg-dark-400 dark:border-dark-400"
    >
      <div class="px-4 pt-6">
        ...
        <nav class="space-y-1 text-sm">
          ...
          <button
            ...
            [class]="
              selectedBoardName() === board.name
                ...
                : 'flex w-full items-center gap-3 rounded-r-full px-4 py-2 text-left text-xs font-medium text-gray-500 hover:bg-gray-100 dark:text-dark-200 dark:hover:bg-dark-500'
            "
          >
          ...
          <button
            type="button"
            class="mt-2 flex w-full items-center gap-3 rounded-r-full px-4 py-2 text-left text-xs font-medium text-primary hover:bg-primary-light/40"
          >
            <span class="text-base">+</span>
      ...
      <div class="px-4 pb-6">
        ...
        >
          <span>🌞</span>
          <button type="button" class="relative h-5 w-10 rounded-full bg-primary-light">
            <span class="absolute left-0.5 top-0.5 h-4 w-4 rounded-full bg-white shadow-sm"></span>
          </button>
          <span>🌙</span>
        </div>
