...
export class LogoIconComponent implements AfterViewInit {
  private readonly viewContainerRef = inject(ViewContainerRef);

  readonly class = input<string | string[] | Set<string> | Record<string, unknown>>('');
  readonly fill = input<string>('red');
